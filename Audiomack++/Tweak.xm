...
%hook AMAdProvidersHelper
- (void)checkPremiumStatus {
}
- (BOOL)currentPremiumStatus {
    return 1;
}
- (void)setCurrentPremiumStatus:(BOOL)arg1 {
    arg1 = 1;
    %orig;
}
- (BOOL)currentPremiumStatusSet {
    return 1;
}
- (void)setCurrentPremiumStatusSet:(BOOL)arg1 {
    arg1 = 1;
    %orig;
}
%end
